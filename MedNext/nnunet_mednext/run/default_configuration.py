...
from nnunet_mednext.paths import network_training_output_dir, preprocessing_output_dir, default_plans_identifier
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(nnunet_mednext.__path__[0], "training", "network_training"),
                              base_module='nnunet_mednext.training.network_training'):
